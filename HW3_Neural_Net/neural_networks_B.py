...
class linear_layer:
    ...
    def forward(self, X):
        ...
        # W_ = np.vstack((self.params['b'],self.params['W']))
        # forward_output = np.dot(X_,W_)
        ...
        if hasattr(module, 'params'):
            for key, _ in module.params.items():
                ...
                if _alpha > 0.0:
                    ...
                    print(M_key,momentum[M_key].shape)
                    momentum[M_key] = momentum[M_key] * _alpha - _learning_rate * g
                    module.params[key] += momentum[M_key]
